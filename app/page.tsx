...
export default function Page() {
  ...
  const poppingImagesPath = process.env.POPPING_IMAGES_PATH || '';
  const characterModelPath = process.env.CHARACTER_MODEL_PATH || '';
  const forestEnvironmentPath = process.env.FOREST_ENVIRONMENT_PATH || '';
  const birdCharactersPath = process.env.BIRD_CHARACTERS_PATH || '';
